<div class="max-w-6xl mx-auto">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right text-sm">
                                <div class="flex space-x-2">
                                    <x-jet-button wire:click="showEditProductModal({{$product->id}})">Edit
                                    </x-jet-button>
                                    <x-jet-button class="bg-red-400 hover:bg-red-600"
                                     wire:click="deleteProduct({{$product->id}})">Delete
                                    </x-jet-button>
    ...
    <div>
        <x-jet-dialog-modal wire:model="showingProductModal">
            ...
            <x-slot name="footer">
                @if ($isEditMode)
                <x-jet-button wire:click="updateProduct">Update</x-jet-button>
                @else
                <x-jet-button wire:click="storeProduct">Create</x-jet-button>
                @endif
            </x-slot>
        </x-jet-dialog-modal>
    </div>
